...
QListView::item:selected {
    ...
    padding-left: 0px;
        ...
        self.calendarWidget = QtWidgets.QTableView(self.window)
        ...
        model = TableModel(df)
        self.calendarWidget.setModel(model)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab), _translate("MainWindow", "Buttons")
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_2), _translate("MainWindow", "Input")
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_4), _translate("MainWindow", "Sliders")
        )
        self.tabWidget.setTabText(
            self.tabWidget.indexOf(self.tab_3), _translate("MainWindow", "Scrolls")
        )
